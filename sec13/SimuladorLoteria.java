    ...
    */
    ...
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            System.out.println("Escolha 6 números para o bilhete(entre 1 e 60)");
            ...
            System.out.println("Quer adicionar mais um bilhete? (s / n)");
            String outroBilhete = scanner.next();

            if (outroBilhete.equals("n")) {
                break;
            }
        }
